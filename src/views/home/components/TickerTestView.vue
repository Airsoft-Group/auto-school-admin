        ...
        <div v-else>
            <div class="flex justify-between items-center mb-4">
                <div class="flex flex-col gap-2">
                    ...
                    <h1 class="text-xl font-bold capitalize text-white">{{ ticketName || 'Bilet nomi' }}</h1>
                </div>
            ...
            <div class="border-white bg-[#696969] p-5 rounded-lg shadow-sm border mb-4">
            ...
            <div class="grid md:gap-6 md:grid-cols-3 grid-cols-1">
                <div class="mb-4">
                    <div class="space-y-3 mb-4">
                        ...
                        >
                            <span
                                class="font-semibold text-white min-w-[40px] bg-[#696969] w-[40px] self-stretch flex items-center justify-center rounded-tl-lg rounded-bl-lg"
                                >F{{ i + 1 }}.</span
                            >
...
const ticketName = computed(() => route.query.name as string)
...
const answerClass = (answerId: string): string => {
    ...
    return 'border-gray-200 bg-[#b6b6b6b0] cursor-pointer  hover:border-[#696969] hover:shadow-md'
}
...
onMounted(async () => {
    ...
    try {
        ...
        if (ExamQuestions && ExamQuestions.length > 0) {
            ticket.value = useExam(ExamQuestions, 'ticket', undefined, sessionId, timeLimit)
        }
    } catch (error) {
